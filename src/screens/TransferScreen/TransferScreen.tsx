...
export default function TransferScreen({ navigation }: RootStackScreenProps<'Menu'>) {
  ...
  const [tx, setTx] = useState<Transfer | undefined>()
      ...
      <Container>
        ...
        <ButtonContainer>
          <StyledButton
              ...
              onPress={() => {
                setTx(new Transfer(recipient, amount, attachment))
